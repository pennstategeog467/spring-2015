@motorway_case: #585858;
@motorway_fill: #5f5f5f;
@rail: #666;
@land: #535339;
@buildings: #66667a;
...
#landcover {
  ...
  ["class"="wood"] { polygon-fill: #355a35; }
  ["class"="scrub"] { polygon-fill: #5c6c4b; }
  ["class"="grass"] { polygon-fill: #405827; }
  ["class"="crop"] { polygon-fill: #4a4935; }
}
